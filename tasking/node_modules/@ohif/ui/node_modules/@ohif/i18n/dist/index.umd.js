(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('i18next'), require('i18next-browser-languagedetector'), require('react-i18next')) :
	typeof define === 'function' && define.amd ? define(['exports', 'i18next', 'i18next-browser-languagedetector', 'react-i18next'], factory) :
	(global = global || self, factory(global['ohif-i18n'] = {}, global.i18next, global.LngDetector, global['react-i18next']));
}(this, function (exports, i18n, LanguageDetector, reactI18next) { 'use strict';

	i18n = i18n && i18n.hasOwnProperty('default') ? i18n['default'] : i18n;
	LanguageDetector = LanguageDetector && LanguageDetector.hasOwnProperty('default') ? LanguageDetector['default'] : LanguageDetector;
